...
void confgenerator_set_defaults_appconf(app_configuration *conf) {
	...
	conf->app_balance_conf.torquetilt_on_speed = APPCONF_BALANCE_TORQUETILT_ON_SPEED;
	conf->app_balance_conf.torquetilt_off_speed = APPCONF_BALANCE_TORQUETILT_OFF_SPEED;
